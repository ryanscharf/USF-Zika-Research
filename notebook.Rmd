...
totstat$Grouping <- NA
totstat[1:13,]$Grouping <- "Federal"
totstat[14:18,]$Grouping <- "State"
totstat[19:25,]$Grouping <- "Local, Mayor"
totstat[26:33,]$Grouping <- "Local, City/County"
totstat[34:47,]$Grouping <- "Local, Congress"
totstat[48,]$Grouping <- "Local, Health"
totstat[49:53,]$Grouping <- "Local, Emergency Management"
totstat$GeneralizedGrouping <- NA
totstat[1:13,]$GeneralizedGrouping <- "Federal"
totstat[14:18,]$GeneralizedGrouping <- "State"
totstat[19:53,]$GeneralizedGrouping <- "Local"
